...
```bash
  git clone git@github.com:Ranjit-Singh-786/Student_suport-ChatBot.git
```
...
- To create a knowledebase of FAQs, click on  button. It will take some time before knowledgebase is created so please wait.
